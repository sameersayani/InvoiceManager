...
export const Navbar: React.FC = () => {
  ...
  return <header className="site-header"><nav className="site-nav" aria-label="Main navigation">
    <Link to="/" className="brand" aria-label="Yesitech home"><span className="brand-mark"><span>Y</span></span><span><strong>yesi</strong>tech<small>Solutions</small></span></Link>
