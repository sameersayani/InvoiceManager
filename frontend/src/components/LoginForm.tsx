...
const handleForgotPasswordClick = () => {
  ...
  if (typeof onForgotPassword === 'function') {
    ...
    console.error('onForgotPassword is not a function:', onForgotPassword);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      {/* Watermark Background Image - Increased opacity and fixed positioning */}
        <div 
      ...
      style={{ 
        ...
        transform: 'translateX(-3%)' // Move image further left
      }}
    />
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="text-center">
                  ...
                  <button
                    ...
                    className="text-gray-600 hover:text-gray-500 text-sm font-medium transition-colors duration-200 block w-full"
                  >
